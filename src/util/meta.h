...
// Convert a method type to a function pointer type taking `this` as the first arg
template<typename T>
struct to_static_function;

template<typename ReturnType, typename ThisType, typename ...ArgTypes>
struct to_static_function<ReturnType(ThisType::*)(ArgTypes...)> {
